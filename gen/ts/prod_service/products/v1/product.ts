...
export interface Product {
     ...
     * Currency ID
     *
     * @generated from protobuf field: uint32 currency_id = 8;
     */
    currencyId: number;
    /**
     * Specification
...
class Product$Type extends MessageType<Product> {
    constructor() {
        super("prod_service.products.v1.Product", [
            ...
            { no: 8, name: "currency_id", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ...
    create(value?: PartialMessage<Product>): Product {
        const message = { id: "", name: "", description: "", imageId: "", price: "", rating: 0, categoryId: "", currencyId: 0, specification: "", updatedAt: "0", createdAt: "0" };
    ...
    internalBinaryWrite(message: Product, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* uint32 currency_id = 8; */
        if (message.currencyId !== 0)
            writer.tag(8, WireType.Varint).uint32(message.currencyId);
