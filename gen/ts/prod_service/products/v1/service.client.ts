...
export interface IProductServiceClient {
    ...
    /**
     * @generated from protobuf rpc: AllProduct(prod_service.products.v1.AllProductRequest) returns (prod_service.products.v1.AllProductResponse);
     */
    allProduct(input: AllProductRequest, options?: RpcOptions): UnaryCall<AllProductRequest, AllProductResponse>;
}
/**
 * @generated from protobuf service prod_service.products.v1.ProductService
 */
