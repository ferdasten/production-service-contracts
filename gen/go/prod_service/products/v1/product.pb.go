...
type Product struct {
	...
	// Currency ID
	CurrencyId uint32 `protobuf:"varint,8,opt,name=currency_id,json=currencyId,proto3" json:"currency_id,omitempty"`
	// Specification
...
var file_prod_service_products_v1_product_proto_rawDesc = []byte{
	...
	0x0a, 0x0b, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20,
